...
function FormEdit() {
    ...
    const fetchForms = async () => {
        try {
            ...
            setFormRawInputData(res?.data?.data?.raw_form_data || []);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:3500/admin/${id}`, {
                method: "PATCH",
                headers: {
            ...
            <Container>
                <div style={{ width: "100%", margin: "0 auto", marginTop: "107px", marginBottom: "20px" }}>
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div style={{ display: "flex", gap: "66rem" }}>
                            ...
                            <Form onSubmit={handleFormSubmit}>
                                ...
                                {formRawInputData.length > 0 && (
                                    <Button type='submit' variant='outline-secondary' style={{ marginTop: "20px" }} size='sm' color='primary'>Update form</Button>
                                )}
                            </Form>
                        </>
                    )}
